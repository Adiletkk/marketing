			...
			<section className={styles.price_list}>
				<div className={styles.price_item}>
					<div className={styles.price_child}>
						<div><h2 className={styles.price_title}>Basic</h2>
							<p className={styles.price_val}>$29 <span className={styles.price_month}>/mo</span></p>
						</div>
					...
					<p className={styles.price_text}>Proin viverra, ligula sit
						amet ultrices semper, ligula arcu tristique sapien
					</p>
					<ul>
				...
				<div className={styles.price_item}>
					<div className={styles.price_child}>
						<div><h2 className={styles.price_title}>Standard</h2>
							<p className={styles.price_val}>$59 <span className={styles.price_month}>/mo</span></p>
						</div>
						<div className={styles.price_img}>
				...
				<div className={styles.price_item}>
					<div className={styles.price_child}>
						<div><h2 className={styles.price_title}>Premium</h2>
							<p className={styles.price_val}>$99 <span className={styles.price_month}>/mo</span></p>
						</div>
						<div className={styles.price_img}>
					...
					<p className={styles.price_text}>Sed lectus. Sed consequat, leo eget
					 bibendum sodales
					</p>
					<ul>
						<li>Auto update mode</li>
