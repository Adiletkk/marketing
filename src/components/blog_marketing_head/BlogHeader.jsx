...
const BlogHeader = () => {
  ...
  return (
    <div className={styles.main_content}>
      <Header />
      <div className={styles.head_inp}>
        <input className={styles.inp2} type="text" placeholder="search..." />
      </div>
      ...
      <div className={styles.mob_cont}>
        <div className={styles.card_mob}>
          <img src={card} alt="" />
          <div>
            <span className={styles.subTitle}>
              04 JUL 2021 <span className={styles.dot}>&#183;</span> 8 min read
            </span>
            <h2 className={styles.comment1}>
              How to Maximize Your ROI Through Scientific SEM?
            </h2>
