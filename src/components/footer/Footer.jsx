      ...
      <section className={styles.foot_feedback}>
        ...
        <div className={styles.foot_mail_content}>
          <div>
            ...
            <span className={styles.foot_mail}>info@example.com</span>
          </div>
          <div>
            <img src={FootLoc} alt="" />{" "}
            <span className={styles.foot_mail}>655 Schaefer Dale</span>
          </div>
        </div>
        <div className={styles.foot_send}>
          <input type="text" placeholder="Email address" />{" "}
          <button className={styles.foot_btn_end}>&#62;</button>
        </div>
      </section>
